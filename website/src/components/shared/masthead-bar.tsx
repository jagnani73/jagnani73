...
export const MastheadBar = () => {
  ...
  return (
    ...
    <div className="relative z-1">
      <div className="flex flex-wrap items-baseline justify-between gap-2 bg-bg px-4 py-3 font-mono text-[13.5px] text-tx3 rail:grid rail:grid-cols-[1fr_auto_1fr] rail:px-11 rail:pt-6 rail:pb-4">
        <Link
          href="/"
