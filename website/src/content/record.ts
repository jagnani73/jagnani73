...
export const RECORD: RecordEntry[] = [
  ...
  },
  {
    ...
    kind: "HACKATHON",
    win: true,
    title: "ETHGlobal New Delhi - Fluence track prize, 3rd place",
  ...
  },
  {
    ...
    kind: "HACKATHON",
    win: true,
    title: "ETHGlobal Prague - Big Blockscout Explorer pool prize",
  ...
  },
  {
    ...
    kind: "HACKATHON",
    win: true,
    title: "ETHOnline - Sign Everything pool prize",
  ...
  // ── 2023 ──
  {
    ...
    kind: "HACKATHON",
    win: true,
    title: "Unfold 2023 - Router Protocol, first place",
  ...
  },
  {
    ...
    kind: "HACKATHON",
    win: true,
    title: "ETHforAll · ETHIndia Online VIII - Quadratic Voting prize",
  ...
  },
  {
    ...
    meta: "IEEE · Best Paper, ViTECoN 2023",
  ...
  },
  {
    ...
    meta: "IEEE · Gold Medal, SRM Research Day",
  ...
  },
  {
    ...
    meta: "IEEE · Dynamic broker load balancing via blockchain naming",
