...
export const shikshakCase: CaseDetail = {
  ...
  fig: {
    component: FigBoard,
    alt: "a blackboard captured as a pixel stream, ~85% less data than video",
  },
  sections: {
    split: {
    ...
    arch: {
      ...
      body: (
        <>
          ...
          video. That array streams over Socket.IO, where the Canvas API
          rebuilds the board; WebRTC carries audio-only so teacher and students
      ...
      flow: [
        {
          stage: "DETECT",
          role: "find + isolate the blackboard",
          tech: ["OpenCV", "Canny"],
        },
        {
          stage: "COMPRESS",
          role: "surface → pixel array, ~85% smaller",
          tech: ["imutils"],
        },
        {
          stage: "STREAM",
          role: "push the array in real time",
          tech: ["Socket.IO"],
        },
        {
          stage: "REBUILD",
          role: "canvas redraw + audio-only voice",
          tech: ["Canvas API", "WebRTC"],
        },
      ],
      ...
      cards: [
        {
          ...
          desc: "teacher sets the boundary before a session",
        },
        {
          name: "pixel-stream canvas",
          desc: "student-side reconstruction of the board",
        },
        { name: "audio-only WebRTC", desc: "voice without the video overhead" },
        {
          name: "data-channel sync",
          desc: "keeping audio aligned with the pixel stream",
        },
      ],
    },
    plates: {
      ...
      plates: [
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473789/jagnani73/projects/shikshak/screenshot-calibrate_1_kaglgd.png",
          cap: "board calibration",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473783/jagnani73/projects/shikshak/screenshot-preview_1_lsp63m.png",
          cap: "the reconstructed board",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473786/jagnani73/projects/shikshak/screenshot-home_1_qehcch.png",
          cap: "the home screen",
        },
      ],
      cta: {
        label: "view the source",
        href: "https://github.com/jagnani73/shikshak",
      },
    },
  },
};
