...
export const goldrushDecoderCase: CaseDetail = {
  ...
  fig: {
    component: FigDecoder,
    alt: "a raw event log decoding into a named, enriched event",
  },
  sections: {
    split: {
    ...
    arch: {
      ...
      body: (
        <>
          At startup,{" "}
          <strong className="font-semibold text-tx">initDecoder</strong> scans a
          protocol directory and builds a map of decoder keys (strings like{" "}
          <strong className="font-semibold text-tx">uniswap-v3:Swap</strong>) to
          handlers registered via{" "}
          <strong className="font-semibold text-tx">.on()</strong>. Each handler
          gets the raw log, the full transaction, and the Covalent client for
          live enrichment. A fallback decoder guarantees the API always returns
      ...
      flow: [
        {
          stage: "REGISTER",
          role: "scan protocols, build the key map",
          tech: ["initDecoder", ".on()"],
        },
        {
          stage: "MATCH",
          role: "log → the right decoder, or fallback",
          tech: ["decoder registry"],
        },
        {
          stage: "DECODE",
          role: "typed, named event object",
          tech: ["TypeScript"],
        },
        {
          stage: "ENRICH",
          role: "token metadata + USD pricing",
          tech: ["Covalent API"],
        },
      ],
      ...
      intro: (
        <>
          ...
          <span className="font-mono text-sig">
            fan out decoder calls in parallel batches
          </span>{" "}
      ...
      cards: [
        {
          ...
          desc: "decoder invocations fanned out, not serialized",
        },
        {
          name: "order preserved",
          desc: "responses re-sequenced to original log order",
        },
        {
          name: "fallback decoder",
          desc: "unknown events still return meaning",
        },
        {
          name: "contributor CLI",
          desc: "yarn add-config scaffolds a new protocol in one command",
        },
      ],
    },
    plates: {
      ...
      plates: [
        {
          kind: "code",
          code: DECODER_CODE,
          cap: "registering a protocol decoder",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766564974/jagnani73/projects/goldrush-decoder/8abf9959-854f-41f2-8b9d-55c48e00866c.png",
          cap: "the decoder, documented",
        },
      ],
      cta: {
        label: "view the source",
        href: "https://github.com/covalenthq/goldrush-decoder",
      },
    },
  },
};
