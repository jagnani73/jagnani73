  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <strong className="font-semibold text-tx">Verifiable Credential</strong>{" "}
          to an employee&apos;s identity wallet. On the job board, the employee
          generates a{" "}
          <strong className="font-semibold text-tx">zero-knowledge proof</strong>{" "}
          that proves employment without revealing data.{" "}
          <strong className="font-semibold text-tx">Redis</strong> manages
          real-time state across the WebSocket and REST layers; ZK proofs replace
          JWTs entirely.
        </>
      ),
      flow: [
        { stage: "VET", role: "admin confirms the org is legitimate", tech: ["Next.js"] },
        { stage: "ISSUE", role: "credential of tenure to the identity wallet", tech: ["Polygon ID", "Iden3"] },
        { stage: "PROVE", role: "zk proof of employment on the job board", tech: ["zero-knowledge"] },
        { stage: "VERIFY", role: "checked, no personal data revealed", tech: ["Redis", "Supabase"] },
      ],
    ...
    },
    {
      ...
      intro: (
        <>
          ...
          encoding employment tenure into one field was a real puzzle. I solved it
          with{" "}
          <span className="font-mono text-sig">SHAKE-128 hashing</span>, converting
          to hex then decimal radix to produce compact, uniquely deterministic
          48-bit values:
        </>
      ),
      cards: [
        { name: "15-digit constraint", desc: "the hard limit on credential attributes" },
        { name: "SHAKE-128 encoding", desc: "hash → hex → decimal radix → 48-bit values that fit" },
        { name: "zk-only auth", desc: "JWTs replaced entirely by proofs; email is for comms only" },
    ...
    },
    {
      ...
      plates: [
        ...
        { kind: "img", src: "https://res.cloudinary.com/jagnani73/image/upload/v1766558074/jagnani73/projects/delinzk/6a559df0-848d-46e9-9b81-a25383c5b89d_npadrq.jpg", cap: "plate 04" },
        { kind: "img", src: "https://res.cloudinary.com/jagnani73/image/upload/v1766558075/jagnani73/projects/delinzk/ea9ad5d5-7066-41a4-b44b-bd2814f37f57_hftzqk.png", cap: "plate 05" },
        { kind: "img", src: "https://res.cloudinary.com/jagnani73/image/upload/v1766558074/jagnani73/projects/delinzk/350ad1c9-a430-42bb-ae52-d28f70b7ae34_to9t6l.png", cap: "plate 06" },
      ],
