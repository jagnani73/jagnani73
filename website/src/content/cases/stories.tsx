...
export const storiesCase: CaseDetail = {
  ...
  fig: {
    component: FigMatch,
    alt: "peers matched on shared tags; every message passes a toxicity gate",
  },
  sections: {
    split: {
    ...
    arch: {
      ...
      body: (
        <>
          Matching is{" "}
          <strong className="font-semibold text-tx">score-based</strong>,
          pairing users with the most shared tags. Messaging runs on{" "}
          ...
          and censored before delivery. Repeated reports trigger an IP + email
          ban via Redis-backed middleware.
        </>
      ),
      flow: [
        ...
        {
          stage: "MATCH",
          role: "highest shared-tag score wins",
          tech: ["scoring"],
        },
        {
          stage: "CHAT",
          role: "real-time, room state in Redis",
          tech: ["Socket.IO", "Redis"],
        },
        {
          stage: "GATE",
          role: "toxic messages censored in transit",
          tech: ["TensorFlow.js"],
        },
      ],
    ...
    cards: {
      ...
      cards: [
        {
          name: "tag matching",
          desc: "seekers and supporters paired by shared concerns",
        },
        {
          name: "toxicity filter",
          desc: "harmful messages censored before they land",
        },
    ...
    plates: {
      ...
      plates: [
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473758/jagnani73/projects/stories/2_1_wwqysl.png",
          cap: "choosing your tags",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473761/jagnani73/projects/stories/3_1_xlmyej.png",
          cap: "an anonymous chat",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473755/jagnani73/projects/stories/4_1_ylfthn.png",
          cap: "the admin panel",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473752/jagnani73/projects/stories/1_1_rnugym.png",
          cap: "the story feed",
        },
      ],
      cta: {
        label: "view the source",
        href: "https://github.com/jagnani73/stories",
      },
    },
  },
};
