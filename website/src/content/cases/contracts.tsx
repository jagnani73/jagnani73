...
export const contractsCase: CaseDetail = {
  ...
  fig: {
    component: FigLedger,
    alt: "every edit appended to an immutable, on-chain audit log",
  },
  sections: {
    split: {
      ...
      serif: (
        <>
          ...
          <span className="text-tx">
            quietly edits a record nobody else can see.
          </span>
        </>
      ),
    ...
    arch: {
      ...
      body: (
        <>
          ...
          . Users authenticate with blockchain accounts; every mutation (an
          edit, a deletion, a settlement) is captured in an{" "}
      ...
      flow: [
        {
          stage: "AUTH",
          role: "sign in with a blockchain account",
          tech: ["Hedera"],
        },
        {
          stage: "RECORD",
          role: "add / edit / settle a shared expense",
          tech: ["Solidity"],
        },
        {
          stage: "APPEND",
          role: "every mutation logged immutably",
          tech: ["audit log"],
        },
        {
          stage: "VIEW",
          role: "one transparent history for all",
          tech: ["Next.js"],
        },
      ],
    ...
    cards: {
      ...
      intro: (
        <>
          I built the full frontend: the blockchain auth flow and the
          transaction UI. The challenge was{" "}
          <span className="font-mono text-sig">
            Hedera&apos;s nascent tooling
          </span>
      ...
      cards: [
        {
          ...
          desc: "wallet-account sign-in, no passwords",
        },
        {
          name: "contract-as-database",
          desc: "expenses persisted as on-chain state",
        },
        {
          name: "immutable audit log",
          desc: "edits and settlements traceable forever",
        },
        {
          name: "sparse-docs debugging",
          desc: "first-principles work on a new platform",
        },
      ],
    },
    plates: {
      ...
      plates: [
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473805/jagnani73/projects/contracts/Screenshot_from_2022-07-03_00-45-39_lskus9.png",
          cap: "the expense view",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473807/jagnani73/projects/contracts/Screenshot_from_2022-07-03_00-46-25_hpuchh.png",
          cap: "splitting an expense",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473811/jagnani73/projects/contracts/Screenshot_from_2022-07-03_00-46-20_hxrgok.png",
          cap: "the audit trail",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1714473801/jagnani73/projects/contracts/Screenshot_from_2022-07-03_00-45-58_qpcdoj.png",
          cap: "settling up",
        },
      ],
      cta: {
        label: "view the source",
        href: "https://github.com/jagnani73/contracts",
      },
    },
  },
};
