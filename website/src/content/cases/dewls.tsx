  ...
  sections: {
      ...
      serif: (
        <>
          ...
          <span className="text-tx">
            Dewls makes the outcome itself the receipt.
          </span>
        </>
      ),
    ...
    arch: {
      ...
      body: (
        <>
          ...
          <strong className="font-semibold text-tx">Hedera</strong> (HSCS +
          HTS), and <strong className="font-semibold text-tx">Rootstock</strong>
          , while a single real-time engine enforces every rule server-side, so
          the client can never cheat.
        </>
      ),
      flow: [
        {
    ...
    plates: {
      ...
      plates: [
        ...
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766566622/jagnani73/projects/dewls/2008978b-b933-4627-8a14-24ecc66d65e7.png",
          cap: "picking a game",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766566731/jagnani73/projects/dewls/4184e2cb-9978-4ef1-9656-a4d063b87c9b.png",
          cap: "the leaderboard",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766566705/jagnani73/projects/dewls/bf8e57c5-ae68-40fd-a5cc-f70c9b1fd320.png",
          cap: "claiming the pot",
        },
      ],
      cta: {
