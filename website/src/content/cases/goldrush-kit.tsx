...
export const goldrushKitCase: CaseDetail = {
  ...
  fig: {
    component: FigKit,
    alt: "a raw API response resolving into a rendered component",
  },
  sections: {
    split: {
      ...
      serif: (
        <>
          ...
          <span className="text-tx">
            before a single pixel of UI ever ships.
          </span>
        </>
      ),
    ...
    arch: {
      ...
      body: (
        <>
          ...
          each is individually consumable or composable into full-page
          templates. A single{" "}
      ...
      flow: [
        {
          stage: "PROVIDE",
          role: "one context: theme, chain, API key",
          tech: ["GoldRushProvider"],
        },
        {
          stage: "FETCH",
          role: "the component pulls its own data",
          tech: ["GoldRush SDK"],
        },
        {
          stage: "NORMALIZE",
          role: "200+ chains, one typed shape",
          tech: ["TypeScript"],
        },
        {
          stage: "RENDER",
          role: "atomic, themeable components",
    ...
    cards: {
      ...
      intro: (
        <>
          I owned the library across the v1.0.x cycle. The subtle,
          trust-critical work was{" "}
          <span className="font-mono text-sig">
            gas &amp; fee unit formatting
          </span>
      ...
      cards: [
        {
          name: "state-preserving pagination",
          desc: "block lists that hold their place across fetches",
        },
        {
          name: "raw transaction logs",
          desc: "the decoded log view, surfaced in the UI",
        },
        {
          name: "in / out indicators",
          desc: "direction at a glance on transaction lists",
        },
        {
          name: "chain-switching",
          desc: "live network swap inside address activity",
        },
      ],
    },
    plates: {
      ...
      plates: [
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766564317/jagnani73/projects/goldrush-kit/81f580da-f9c3-4f15-8faf-ca37eef2fedd.png",
          cap: "components in Storybook",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766564635/jagnani73/projects/goldrush-kit/ac94b6a1-a9c4-42cd-a318-5c80b2549824.png",
          cap: "token balances, rendered",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766564330/jagnani73/projects/goldrush-kit/0172911e-a1c9-4796-aea3-05bee4f8d65f.png",
          cap: "transaction list view",
        },
        {
          kind: "img",
          src: "https://res.cloudinary.com/jagnani73/image/upload/v1766565005/jagnani73/projects/goldrush-kit/e0dd45f7-2dea-49bc-ac33-a7bbfdfeda05.png",
          cap: "the NFT wallet view",
        },
      ],
      cta: {
