...
export const bharatBeaconCase: CaseDetail = {
  ...
  fig: {
    component: FigBeacon,
    alt: "distress signals polled onto the government dashboard in real time",
  },
  sections: {
    split: {
    ...
    arch: {
      ...
      body: (
        <>
          I built the{" "}
          <strong className="font-semibold text-tx">Government Portal</strong>:
          a real-time dashboard plotting incoming distress calls as pinpoints on
          an interactive{" "}
          <strong className="font-semibold text-tx">MapBox</strong> map. To stay
          current without a persistent connection, I used HTTP polling to
          continuously fetch the latest device signals and metadata.
        </>
      ),
      flow: [
        {
          stage: "SIGNAL",
          role: "IoT devices transmit distress",
          tech: ["IoT"],
        },
        {
          stage: "POLL",
          role: "fetch latest signals + metadata",
          tech: ["HTTP polling"],
        },
        {
          stage: "MAP",
          role: "plot pinpoints in real time",
          tech: ["MapBox API"],
        },
        {
          stage: "RESPOND",
          role: "authorities triage live emergencies",
          tech: ["dashboard"],
        },
      ],
    ...
    cards: {
      ...
      intro: (
        <>
          ...
          <span className="font-mono text-sig">live geographic overview</span>{" "}
          of every active emergency:
        </>
      ),
      cards: [
        {
          name: "live distress map",
          desc: "MapBox pinpoints for each incoming signal",
        },
        {
          name: "HTTP polling",
          desc: "fresh signals without a persistent socket",
        },
        {
          name: "device metadata",
          desc: "context attached to every distress call",
        },
        {
          name: "three-phase model",
          desc: "mitigation, response, and recovery",
        },
      ],
    },
    plates: {
